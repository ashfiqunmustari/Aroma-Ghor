      ...
      <div className="card bg-base-100 w-96 shadow-sm h-full flex flex-col">
        ...
        <div className="card-body flex flex-col justify-between flex-1 items-center text-center">
          <div className="flex gap-4">
            ...
            {/*Wish List button ---------------------------------------------------*/}
            <button
              onClick={() => handleWishlistButton(!liked)}
              className="p-1 text-pink-500 hover:text-pink-500"
              style={{ backgroundColor: "white", border: "none", padding: "0.25rem" }}    
            >
              {liked ? <FaHeart size={19} title="Remove From Wishlist"/> : <CiHeart size={24} title="Add to wishlist"/>}
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <select
              ...
              defaultValue="100ml - Full Size"
            >
              <option>5ml</option>
              <option>10ml</option>
              <option>20ml</option>
              <option>100ml Full Size</option>
            </select>
          </div>
          {/*Price-Section--------------------------------------------------*/}
          <div className="flex items-center gap-2 mt-1">
            <span className="font-semibold">Price:</span>
            <span>BDT {perfume.price}</span>{" "}
          </div>
